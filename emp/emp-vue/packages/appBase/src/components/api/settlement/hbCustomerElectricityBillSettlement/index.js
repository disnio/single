 ...
 * @LastEditTime : 2020-01-19 14:01:06
 */
...
// 新增河北客户电费预结算--计算
export function countKhyjsDataByHb(obj) {
  return fetch({
    url: '/api/balance/hbPreSettlement/calcData',
    method: 'post',
    data: obj
  });
}
...
export function updateStatus(query) {
  return fetch({
    url: '/api/balance/hbPreSettlement/updateStatus',
    method: 'get',
    params: query
  });
}
