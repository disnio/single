...
export function getPageList(data) {
  return fetch({
    url: '/api/balance/jsSdgsdfjsJs/getPageList',
    method: 'get',
    params: data
  })
}
...
export function insertData(data) {
  return fetch({
    url: '/api/balance/jsSdgsdfjsJs/insertData',
    method: 'get',
    params: data
  })
}
...
export function getDetailPageList(data) {
  return fetch({
    url: '/api/balance/jsSdgsdfjsJsDetail/getDetailPageList',
    method: 'get',
    params: data
  })
}
...
export function countData(data) {
  return fetch({
    url: `/api/balance/jsSdgsdfjsJsDetail/countData`,
    method: 'post',
    data
  })
}
...
export function editSubmit(data) {
  return fetch({
    url: `/api/balance/jsSdgsdfjsJsDetail/${data.mainId}`,
    method: 'put',
    data
  })
}
...
export function exportExcel(data) {
  let token = getToken()
  let url = "@common/api/balance/jsSdgsdfjsJsDetail/exportExcel?token=" + token
  for (let k in data) {
    let value = data[k] != undefined ? data[k] : "";
    url += `&${k}=${encodeURIComponent(value)}`;
  }
