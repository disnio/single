      ...
      <!--               三级查询:     区域------区域公司------售电公司                        -->
<template>
<!-- #4297 gaoaining 添加类名filter-container 减少行与行的间距 修改公共组件的label-width的值start-->
  <div class="app-container filter-container" style="display:inline-block;"> 
    <el-form :inline="true" :model="searchListQuery" label-width="100px">
<!-- #4297 gaoaining 添加类名filter-container 减少行与行的间距 修改公共组件的label-width的值end-->
      <!-- 去掉lable后的： -->
