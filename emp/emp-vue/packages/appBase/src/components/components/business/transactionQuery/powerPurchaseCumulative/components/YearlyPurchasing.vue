 ...
 * @最新修改内容: 
 * @LastEditTime : 2020-01-07 10:31:11
 -->
<template>
  <div style="margin:0 10px;">
    <!-- 通用表格组件 start -->
    <div class="table-con">
      <h2 v-if="this.getModelCode == 'powerPurchaseCumulative'" style="text-align:center">能销公司购电累计情况</h2>
      <h2 v-else style="text-align:center">{{this.orgName}}{{this.issue}}能销公司购电累计情况</h2>
