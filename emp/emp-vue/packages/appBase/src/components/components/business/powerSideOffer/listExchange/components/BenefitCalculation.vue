 ...
 * @最新修改内容: 
 * @LastEditTime: 2019-12-10 17:16:13
 -->
<template>
  <div class="app-container calendar-list-container">
    ...
    >
      <div :style="{paddingRight:'10px',height:(layoutInfo.height-20)+'px'}">
...
<script>
import { fdBenefitCalculationObj ,getFdListedTransactionEstimating} from "@common/api/business/solutionBenefitCalculation/index";
...
export default {
  ...
  methods: {
    ...
    init(data, schemeNameCode) {
      ...
      getFdListedTransactionEstimating(parme).then(res => {
        if (res.rel) {
