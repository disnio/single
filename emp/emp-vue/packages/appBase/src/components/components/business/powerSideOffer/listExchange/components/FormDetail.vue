 ...
 * @最新修改内容: 
 * @LastEditTime: 2020-08-25 15:55:27
 -->
<template>
            ...
            <div>
              ...
              >
                ...
                <!-- 20200204 阿彪 #3693  detailInfo.stateCode=='27'为已变更的数据状态，需要展示√-->
                  ...
                  <!-- 省内交易 -->
                  <!-- 2019-11-18 #2703  郑文杰 交易管理--发电侧报价方案页面优化  添加 交易品种为抽水蓄能交易的判断-->
                  <province-trade
                    :btns="btns"
                    v-if="schemeInfo.tradeVarietyCode=='jypz01'||schemeInfo.tradeVarietyCode=='jypz11'"
                    :orgInfo="orgInfo"
...
export default {
  ...
  methods: {
    ...
    setTabList(key, data) {
      ...
      data.forEach((item, index) => {
        ...
        if (
          ...
          this.schemeInfo.tradeVarietyCode == "jypz11" //添加交易品种为抽水蓄能交易的判断
        ) {
      ...
      for (let key in detailList) {
        ...
        this.pricingProposalOption.forEach(item => {
          if (key == item.propCode) {
            ...
            //2019-11-13 #2495 滕超 查看编辑默认选中第一个标签页
   ...
   async save(state) {
      ...
      parame.tradeVarietyCode = this.schemeInfo.tradeVarietyCode;
      // parame.detailList.tradingUnitName= this.schemeInfo.tradingUnitName;
      ...
      // #3545 2020-01-14 张亮三 解决当清空用电企业时id不 为空的问题 start
