 ...
 * @最新修改内容: 
 * @LastEditTime : 2020-02-04 11:00:29
 -->
<template>
<!--跨省交易-->
...
export default {
  ...
  props: {
    ...
    unitMaps:{//20191218 阿彪 #3172  unitMap改为unitMaps解决重复定义bug导致页面空白
      type:Object
    }
  },
  data() {
  ...
  methods: {
    ...
    checkTab(data) {
      ...
      for (let i = 0, l = this.tableList.length; i < l; i++) {
        ...
        // if (dataJson.customerName.length==0||dataJson.customerName == "" ||typeof dataJson.customerName == "undefined") {
