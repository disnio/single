 ...
 * @最新修改内容: 
 * @LastEditTime: 2020-08-17 14:18:32
 -->
<template>
  <div class="app-container calendar-list-container" style="margin:0 10px;">
    <!-- 通用表格组件 start -->
    <div class="table-con">
      <!--2020-3-3 #3834 zhangp  “年度交易”页面去掉“度”字-->
      <h2 v-if="this.getModelCode == 'DirectTradingOfPowerPlants'" style="text-align:center">年度交易累计</h2>
