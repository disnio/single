 ...
 * @最新修改内容: 
 * @LastEditTime : 2020-01-06 14:34:25
 -->
<template>
  <div style="margin:0 10px;">
    <!-- 通用表格组件 start -->
    <div class="table-con">
      <h2  v-if="this.getModelCode == 'TheCumulativeSigning'" style="text-align:center">能销公司签约累计情况</h2>
      <h2 v-else style="text-align:center">{{this.orgName}}{{this.issue}}能销公司签约累计情况123</h2>
...
const CustomTableLjqy = () => import("@common/hnReport/components/CustomTableLjqy");
export default {
