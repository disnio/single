 ...
 * @最新修改内容: 
 * @LastEditTime: 2020-05-27 15:18:03
 -->
<template>
...
export default {
  ...
  watch: {
    ...
    resultTableData: {
      ...
      handler: function(newVal, oldVal) {
        this.dialogHeight =500;//20200213 阿彪 #3736 解决表格纵向错位
        this.tableData = newVal.result;
        this.tableHeader = this.resultTableData.tableHeader;
        this.setViewsList();
        setTimeout(() => {//20200213 阿彪 #3736 解决表格纵向错位
  ...
  methods: {
    setViewsList() {
      ...
      // console.log( this.tableRowSpan,999);
    ...
    setRowspan(data, key, nowRowIndex, rowIndex, columnIndex, rowspan, keyArr) {
      ...
      // if(!isRow){
      //     console.log(nowRowIndex,rowIndex,columnIndex);
      //     console.log(keyArr[columnIndex - 1]);
      ...
      for (let key in this.dataKeys) {
        ...
        if (rowIndex > 0) {
          if (typeof this.rowspanKey[key] != "undefined") {
            ...
            // console.log(this.tableData[rowIndex - 1][key] ,data[key],key,9999999999998);
            ...
            if (this.tableData[rowIndex - 1][key] == data[key]&&this.tableData[rowIndex - 1]['orgName'] == data['orgName']) {
    ...
    objectSpanMethod({ row, column, rowIndex, columnIndex }) {
      ...
      if (rowIndex > 33 && rowIndex < 36 && columnIndex < 3) {
        // console.log(this.tableRowSpan,99999,rowIndex);
      }
