  ...
  <div class="app-container calendar-list-container">
          ...
          <el-row>
            <el-col :span="24">
              <el-button
                ...
                @click="reckon"
              >开始计算</el-button>
              <div class="txt-right unit-info">单位:{{units.priceUnit}},{{units.electricityUnit}},{{units.amountUnit}}</div>
            </el-col>
          </el-row>
          <!-- <el-table
            :key="tableKey"
    ...
    >
      ...
      >
        ...
        <el-table-column
          align="center"
          :label="'合同竞价电量('+units.electricityUnit+')'"
        >
          <template slot-scope='scope'>
...
} from "@common/api/business/solutionBenefitCalculation/index";// import { reckon } from "@common/api/business/powerSideOffer/centralizedBidding/index";
  ...
  methods: {
    init(data, schemeNameCode) {
     ...
     if (data.tradeWayCode == "jyfs02") {
        ...
        sdSBXSBenefitCalculationObj(parme).then(res => {
          this.back(res);
        });
      }
    },
