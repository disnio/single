<template>
  ...
  <div class="app-container calendar-list-container">
    <!-- 李志佳 2019年11月27日15:32:55 只在月季数据中显示 -->
    <!-- <el-row v-if="this.announcementInfoData.tradeCycleCode=='jyzq03'">  
      <el-col :span="6">
        <div>月竞总电量:{{totalMonthBidElectricity}} {{unitMap.electricityUnit}}</div>
      </el-col>
      <el-col :span="6">
        <div>省内交易电量:{{totalMonthBidProvElectricity}} {{unitMap.electricityUnit}}</div>
      </el-col>
      <el-col :span="6">
        <div>省内交易电量占比:{{totalMonthBidProvProportion|keepTwoNum}} %</div>
      </el-col>
      <el-col :span="6">
      ...
      if (proportion != 100) {
        ...
        this.tableList.forEach((item, index) => {
          ...
          item.declarationElectricity =
            (this.numberArray[index] / 100) * this.totalMonthBidProvElectricity;
        });
      }
