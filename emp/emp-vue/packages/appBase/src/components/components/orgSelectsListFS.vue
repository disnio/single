<template>
  <div class="app-container filter-collapse" style="display:inline-block;">
    <div class="filter-container filter-collapse">
      <el-form
        class="demo-form-inline form-inline-168"
        :inline="true"
        :model="searchListQuery"
        label-width="80px"
      >
        ...
        <el-form-item label="组织名称">
          <el-select
            ...
            placeholder="请选择"
            style="line-height:18px; width:160px;"
            class="four-col left"
          >
            <el-option
...
.filter-collapse .el-input__inner {
