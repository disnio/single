          ...
          <template v-for="(item, index) in columns">
            ...
            >
               <template slot-scope="scope">
                  <span v-if="item.label == '时间'||item.label == '时点'||item.label == '报价段'||item.label == '参数类型'" style="width:80%" size="mini">{{scope.row[item.prop]}}</span>
           ...
           <el-table-column
            ...
            <template v-for="(items, indexs) in item.children">
                ...
                >
                  <template slot-scope="scope">
                    <span v-if="items.label == '时间'||items.label == '时点'||items.label == '报价段'||items.label == '参数类型'" style="width:80%" size="mini">{{scope.row[items.prop]}}</span>
                    <el-input v-else v-model="scope.row[items.prop]"></el-input>
                  </template>
                </el-table-column>
              </template>
            </el-table-column>
